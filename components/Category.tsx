  ...
  return (
    <div className="max-w-8xl mx-auto px-6 py-10 items-center">
      <div className="flex flex-col p-4">
        <span className={`${caramel.className} text-center text-[30px] md:text-[50px] text-[#b32126]`}>Categories</span>
          ...
          return (
            ...
            <div
             ...
             <div className={`relative flex-shrink-0 w-full md:w-[360px] flex xl:items-center xl:justify-center
              ...
              >
                <h2
                  className={`${caramel.className} text-[#b32126] text-[30px] md:text-[50px] mb-3`}
                >
                  {item.name}
                </h2>
